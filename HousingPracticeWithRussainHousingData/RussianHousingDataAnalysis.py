...
##*********************MISSING DATA TOP*****************
##                                       Total   Percent
##hospital_beds_raion                    14441  0.473926<----Correlated columns make no sense
##build_year                             13605  0.446490<----Correlated to 
##state                                  13559  0.444980<----Correlated columns make no sense
##cafe_avg_price_500                     13281  0.435857
##cafe_sum_500_max_price_avg             13281  0.435857
##cafe_sum_500_min_price_avg             13281  0.435857
##max_floor                               9572  0.314135<----Correlated to floor, kitch_sq, build_year
##material                                9572  0.314135
##num_room                                9572  0.314135<----Correlated to life_sq, full_sq, kitch_sq(0.12)
##kitch_sq                                9572  0.314135<----Correlated to full_sq, max_floor(0.73), floor(0.38)
##preschool_quota                         6688  0.219487<----Correlated to build_count_1971-1995, work_female, raion_popul, work_all, work_male, children_preschool, 0_6_all, 0_6_male
##school_quota                            6685  0.219389<----Correlated to raion_popul,work_female,work_all,0_17_female,children_preschool,0_6_all,0_17_all,0_6_male,0_13_all
##cafe_sum_1000_min_price_avg             6524  0.214105
##cafe_sum_1000_max_price_avg             6524  0.214105
##cafe_avg_price_1000                     6524  0.214105
##life_sq                                 6383  0.209478<----Correlated to full_sq, num_room
...
##                    for currentBoostRound in np.arange(1000, 10010, 10):
...
##for currentBoostRound in np.arange(650, 10010, 10):##1000, 10010, 10
##    for currentEta in np.arange(0.01, 0.31, 0.1):
##        for currentColsampleByTree in np.arange(0.3,0.9,0.1):
##            for currentSubsample in np.arange(0.3,0.9,0.1):
##                for currentGamma in np.arange(0,0.21,0.1):
...
model_xgb = xgb.XGBRegressor(
    n_estimators=100000,
    max_depth=14,
    learning_rate=0.05,reg_alpha=1,subsample=0.7, colsample_bytree=0.7, gamma=10) #the params were tuned using xgb.cv
